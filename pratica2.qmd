...
::: {.fontsize80}
::: {.nonincremental}
Faça um programa que receba uma frase e imprima a palavra dessa frase com o maior número de vogais e a quantidade de vogais dessa palavra. Utilize **vetores** e a estrutura de repetição ***for*** para resolver este problema.
