...
Quais são as motivações para se modularizar um programa?
 
  3Abordagem dividir para conquistar: torna o desenvolvimento de programas mais gerenciável, construindo programas a partir de peças mais simples e menores.
  4Reutilização de software: o uso de classes e métodos existentes como blocos de construção para criar novos programas.
