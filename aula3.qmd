...
- Usualmente colocam-se primeiro os atributos, depois os construtores e, por fim, os métodos.
:::
...
[Variáveis locais]{.alert} são frequentemente utilizadas como posições de [memória temporárias]{.alert} para ajudar um método a completar sua tarefa. 
:::
