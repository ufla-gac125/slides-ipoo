...
:::
::::
[Mas e se eu desejar encontrar um elemento na lista a partir de suas características?]{.fontsize80 style="color:darkblue;"}

- [Por exemplo, em uma lista de contas bancárias eu preciso encontar aquela cujo número é 1234.]{.fontsize80}
...
```
1. Método para buscar uma conta número `num` e, se encontar, retornando o objeto `ContaBancaria` correspondente.
2. Percorrendo a lista de contas bancárias.
3. Se nenhuma conta da lista tiver o número `num`, o *null* será retornado para indicar que a conta não foi encontrada.
:::
::::
