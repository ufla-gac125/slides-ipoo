...
Colocar slides explicando sobre esse paradigma de programação.
...
# Métodos e Parâmetros {background-color="#fb8c0e"}
...
Além disso, métodos podem ter [parâmetros]{.alert} para [fornecer informações adicionais]{.alert} à tarefa que se deseja realizar.
...
- [Cada parâmetro tem um **tipo** e um **nome**. Nessa assinatura, o método tem um parâmetro do tipo *float* chamado *valor*.]{.fontsize70}
:::
