...
O Jogo World-of-Zuul
  ...
  2Desse modo, veremos como estender a sua implementação, discutindo os apectos do design de classes existente.
  3Perceberemos que essa versão original tem exemplos de decisões de design ruins.
  
    Veremos como isso influencia nossas tarefas e como corrigi-las.
  
  4O problema de um design ruim normalmente não está relacionado com a complexidade do problema que se deseja solucionar.
...
Como avaliar se um design de classe é bom ou ruim?
 ...
 2Dois parâmetros são fundamentais para isso:
