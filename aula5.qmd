...
[Quais as vantagens de fazer com que a única forma de se comunicar com um objeto e acessar seus dados seja por meio dos métodos?]{style="color:darkblue;"}
:::
...
:::{.fontsize80}
[Uma vez que Java é uma linguagem de programação orientada a objetos, então o encapsulamento de dados está garantido? Ou seja, os atributos de uma classe em Java são inacessíveis fora dela?]{style="color:darkblue;"}
:::
